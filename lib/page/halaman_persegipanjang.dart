                  ...
                  ElevatedButton(onPressed: (){
                    if (panjang.text == "" || lebar.text =="") {
                        Fluttertoast.showToast(
	                        msg: "Lebar dan Panjang Persegi panjang belum diisi!",
                          backgroundColor: Colors.red,
                          gravity: ToastGravity.CENTER,
                          timeInSecForIosWeb: 3, //lama muncul toast, 3 detik
                          webPosition: "center",//posisi toast kalau dijalankan di browser webBgColor: 	webColor: "orange",//background utk dijalankan di browser
                          toastLength: Toast.LENGTH_LONG);
                    } else {	
	                    double hasilluas =
                      2 * (double.parse(panjang.text) + double.parse(lebar.text));
